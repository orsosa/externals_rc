...
Float_t Ebeam, x, Q2; 
 ...
 for(int nv=0;  nv<nvbins; nv++){  
  for(int nq=0; nq<nqbins;nq++){
   in >> Ebeam >> Eprime[nq][nv] >> Theta[nq][nv] >> Xb[nq][nv] >> Q2 >> sigma_Born_C[nq][nv] >> sigma_BornIn_C[nq][nv] >> sigma_BornQE_C[nq][nv]
 ...
 for(int nv=0;  nv<nvbins; nv++){  
  for(int nq=0; nq<nqbins;nq++){
   in >> Ebeam >> Eprime[nq][nv] >> Theta[nq][nv] >> Xb[nq][nv] >> Q2 >> sigma_Born_Fe[nq][nv] >> sigma_BornIn_Fe[nq][nv] >> sigma_BornQE_Fe[nq][nv]
 ...
 for(int nv=0;  nv<nvbins; nv++){  
  for(int nq=0; nq<nqbins;nq++){
   in >> Ebeam >> Eprime[nq][nv] >> Theta[nq][nv] >> Xb[nq][nv] >> Q2 >> sigma_Born_Pb[nq][nv] >> sigma_BornIn_Pb[nq][nv] >> sigma_BornQE_Pb[nq][nv]
